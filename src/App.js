...
class App extends Component{
    ...
    deleteTodo = (id) => {
      ...
      .then(res =>  this.setState({todos:[...this.state.todos.filter(list => list.id !== id)]}));
    }
...
render(){
  return (
    ...
    <div className="App">
      ...
      <Todos todos = {this.state.todos} isCompleted = {this.isCompleted} deleteTodo = {this.deleteTodo} />
      </React.Fragment>)} />
